  ...
  return (
    <Layout>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-itek-200 rounded-full blur-3xl opacity-20 animate-pulse-slow" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-itek-200 rounded-full blur-3xl opacity-20 animate-pulse-slow" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-up">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <Link
                  to="/contact"
                  className="inline-flex h-11 items-center justify-center rounded-md border border-itek-200 bg-background px-6 py-3 text-sm font-medium transition-colors hover:bg-itek-50 hover:text-itek-700 focus:outline-none focus:ring-2 focus:ring-itek-400 focus:ring-offset-2"
                >
                  Contact Us
                </Link>
              </div>
            ...
            <div className="lg:block hidden">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-radial from-itek-50 to-transparent opacity-70 -z-10"></div>
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-24 bg-itek-600 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-mesh-pattern opacity-5" />
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-itek-500 rounded-full blur-3xl opacity-20" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-itek-500 rounded-full blur-3xl opacity-20" />
